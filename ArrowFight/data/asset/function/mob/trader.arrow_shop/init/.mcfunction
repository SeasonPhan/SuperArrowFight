...
# 商品
    ...
    # ゴーレム矢
        ...
        data modify entity @s Offers.Recipes append value {rewardExp:0b,maxUses:2147483647,buy:{id:"minecraft:stone",count:1},sell:{id:"minecraft:grass_block",count:1}}
        data modify entity @s Offers.Recipes[11].buy set value {id:"minecraft:iron_block",count:1}
        data modify entity @s Offers.Recipes[11].buyB set value {id:"minecraft:emerald",count:12}
