...
# パーティクル
    particle entity_effect{color:[0.3,0.57,0.19,1.0]} ~ ~ ~ 1.5 1.5 1.5 1 20 force @a[distance=..64]
    particle dust{color:[0.3,0.57,0.19],scale:2} ~ ~ ~ 1.5 1.5 1.5 1 5 force @a[distance=..64]

# 範囲内のプレイヤーに毒を付与する
    effect give @a[distance=..3] poison 1 2
