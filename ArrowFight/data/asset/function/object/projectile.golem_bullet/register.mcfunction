#> asset:object/projectile.golem_bullet/register
#
# Objectのデータを指定
#
...
# ID (int)
    data modify storage asset:object ID set value "projectile.golem_bullet"
# フィールド: 
    ...
    # item
        data modify storage asset:object Field.Item set value {id:"minecraft:iron_chestplate",count:1}
    # item_display
